        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-6">
              <img src="/logo-white.svg" alt="Snap Plant" className="h-8" />
              <span className="ml-2 text-lg font-bold">Snap Plant</span>
            </div>
            <p className="text-gray-400">
              The ultimate plant identification app that helps you discover and learn about the plants around you.
            </p>
          </div>
