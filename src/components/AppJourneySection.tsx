...
const AppJourneySection = () => {
  ...
  return (
    <section
      id="app-journey"
      ref={sectionRef}
      className="bg-gradient-to-b from-white via-plant/5 to-white py-20 overflow-x-hidden"
    >
      <div className="section-container scale-100 sm:scale-105 md:scale-110 transition-transform duration-300 origin-top">
