...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="section-container relative z-10 flex flex-col lg:flex-row items-center">
        <div className="lg:w-1/2 text-center lg:text-left mb-10 lg:mb-0">
          ...
          <p className="reveal text-lg md:text-xl text-gray-700 mb-8 max-w-lg mx-auto lg:mx-0">
            Point your camera, snap a photo, and instantly discover detailed
            information about any plant around you. Build your personal plant
            collection and become a botanical expert.
          </p>
      ...
      <div className="absolute bottom-6 sm:bottom-10 inset-x-0 flex justify-center animate-bounce">
        <a
          href="#app-journey"
          className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-white shadow-md flex items-center justify-center hover:bg-gray-100 transition-colors"
        >
          <ArrowDown className="h-5 w-5 sm:h-6 sm:w-6 text-plant" />
        </a>
      </div>
    </section>
  );
